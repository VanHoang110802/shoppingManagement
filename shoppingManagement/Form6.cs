        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
{
     ...
     "); User Id=HR; Password=hr";
        ...
        {
            string connstr = "Data Source=DESKTOP-DG3SFBV\\SQLEXPRESS;Initial Catalog=TK_MK;Persist Security Info=True;User ID=sa;Password=11082002;Trust Server Certificate=True";
            OracleConnection con = new OracleConnection(connstr);
